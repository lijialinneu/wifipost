...
public class UpdateActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String TAG = "asdf UpdateActivity";
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(
                    "/data/data/lijialin.wifipost/databases/wifipost.db",null);

            if(db != null) {

                StringBuffer stringBuffer = new StringBuffer();
                stringBuffer.append("UPDATE  user SET username = '");
                stringBuffer.append(username);
                stringBuffer.append("', password =  '");
                stringBuffer.append(password);
                stringBuffer.append("'");
                System.out.println("asdf "+ stringBuffer.toString());
